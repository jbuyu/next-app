    ...
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        <Image
          ...
          onClick={() => router.push("/")}
        />
        <form className="flex px-6 py-3 md:ml-10 md:mr-5 border border-gray-200 rounded-full
        ...
        <Avatar
          className="ml-auto"
          url="https://images.unsplash.com/photo-1564932436587-c6ea959a4053?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1120&q=80"
        />
      </div>
      {/* headeroptins */}
